...
MODEL="./checkpoints/Qwen/VizWiz" # Set the path if you do not want to load from huggingface directly
# ATTENTION: specify the path to your training data, which should be a json file consisting of a list of conversations.
# See the section for finetuning in README for more information.
OUTPUT_MODEL_PATH="./checkpoints/Qwen/ImageNet"
PREVIOUS_MODEL_PATH="./checkpoints/Qwen/VizWiz"
DATA="playground/Instructions_Light/ImageNet/train_3000.json"
